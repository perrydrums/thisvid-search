-- "userId" / "friendId" on legacy `searches` are bigint; RPC still receives text from the client.
...
comment on function public.insert_search_log is
    'Inserts searches row; casts "userId"/"friendId" from text params to bigint for legacy schema.';
