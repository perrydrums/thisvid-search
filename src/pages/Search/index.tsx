      ...
      <main className={chrome.main}>
        <form className={styles.formBlock} onSubmit={submit}>
          ...
          {!isV2Mode && (
            <p className={styles.error}>
              ...
              <strong>{modes[searchState.mode]}</strong>. Use the{' '}
              <a href="/legacy/search">legacy search</a> page for other modes.
            </p>
          )}
        ...
        <div className={styles.resultsBlock} ref={resultsRef}>
          ...
          <p className={styles.footerNote}>
            <a href="/legacy/search">Click here for the legacy search</a>
          </p>
        </div>
      </main>
    </div>
