...
const Result = ({title, url, duration, views, date, isFriend = false, imageSrc = null, page = null, isPrivate = false}) => {
  ...
  return (
    ...
    >
      <div>
        {imageSrc &&
          <div className="thumbnail" style={{backgroundImage: `url(${imageSrc})`}} onClick={() => window.open(url, '_blank')}>
      ...
      <div className="details">
        ...
        {!isPrivate ?
          <div
            ...
            onClick={downloadUrl ? () => window.open(downloadUrl, '_blank') : (!loading ? fetchDownloadUrl : null)}
          >
